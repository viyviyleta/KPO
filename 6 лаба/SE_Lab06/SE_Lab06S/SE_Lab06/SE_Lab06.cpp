...
#include <iomanip>
#include <windows.h>
#include "C:\Users\viy.viy.leta\OneDrive\Рабочий стол\лабы\лаб. 06 +\SE_Lab06\SE_Lab06S\SE_Lab06L\Dictionary.h"
#pragma comment(lib, "C:\\Users\\viy.viy.leta\\OneDrive\\Рабочий стол\\лабы\\лаб. 06 +\\SE_Lab06\\SE_Lab06S\\Debug\\SE_Lab06L.lib")
...
int main() {
	...
	try {
		...
		Entry e1 = { 1, "Барковский" }, e2 = { 2, "Белодед" }, e3 = { 3, "Наркевич" }, e4 = { 4, "Шиман" }, e5 = { 5, "Якушева" }, e6 = { 6, "Башура" }, e7 = { 7, "Калашникова" }, e8 = { 3, "Дорошенко" };
		AddEntry(d1, e1);
		AddEntry(d1, e2);
		AddEntry(d1, e3);
		AddEntry(d1, e4);
		...
		Entry s1 = { 1, "Ермолина" }, s2 = { 8, "Себа" }, s3 = { 3, "Бань" }, s4 = { 4, "Костюкович" }, s5 = { 5, "Вертинский" }, s6 = { 6, "Дормат" }, s7 = { 7, "Грибоедов" };
		AddEntry(d2, s1);
		AddEntry(d2, s2);
		AddEntry(d2, s3);
		AddEntry(d2, s4);
